...
ADT_USE_BREAKEVEN_LOCK: bool  = os.getenv("ADT_USE_BREAKEVEN_LOCK", "true").lower() in ("true", "1", "yes")
ADT_BREAKEVEN_TRIGGER_PCT: float = float(os.getenv("ADT_BREAKEVEN_TRIGGER_PCT", "0.02"))  # Active le verrou net à +2%
ADT_BREAKEVEN_EXIT_SLIPPAGE_PCT: float = float(os.getenv("ADT_BREAKEVEN_EXIT_SLIPPAGE_PCT", "0.0005"))  # Slippage SELL estimé pour le calcul net
